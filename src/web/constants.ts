...
// 3. 地方グループの定義（北から順）
export const REGION_GROUPS: Array<{ label: string; codes: string[] }> = [
...
export type PrefCell = { code: string; col: number; row: number };
export const REGION_GRID_LAYOUT: Array<{ cols: number; prefs: PrefCell[] }> = [
  // 0: 北海道地方
